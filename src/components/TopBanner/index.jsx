...
const banners = {
  ...
  doctor: [
    "https://raphacure-public-images.s3.ap-south-1.amazonaws.com/120521-1736424148728.png",
    "https://raphacure-public-images.s3.ap-south-1.amazonaws.com/120521-1736426162942.png",
  ],
  dentalcarebanner: [dentalcarebanner, false],
  eyecarebanner:
    "https://raphacure-public-images.s3.ap-south-1.amazonaws.com/120521-1736423317465.png",
  pharmacy: [pharmacy],

  ctmri: [
    ctmri1,
    "https://raphacure-public-images.s3.ap-south-1.amazonaws.com/120521-1736425228517.png",
  ],
  ayurveda: [
    "https://raphacure-public-images.s3.ap-south-1.amazonaws.com/120521-1736423528721.png",
    ayurveda2,
  ],
  mentalwellness: [
    "https://raphacure-public-images.s3.ap-south-1.amazonaws.com/120521-1736425814297.png",
    mentalwellness2,
  ],
  womens: [
    womens1,
    "https://raphacure-public-images.s3.ap-south-1.amazonaws.com/120521-1736425652336.png",
  ],
