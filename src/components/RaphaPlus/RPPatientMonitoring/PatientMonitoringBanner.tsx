    ...
    <PatientMoitoringBannerStyled>
      <div className="Container">
        <div className="BackgroundImage">
          <img src="https://raphacure-public-images.s3.ap-south-1.amazonaws.com/120521-1736415272016.png" alt="" className="img_div" />
        </div>
        <div className="Contents">
          ...
          <div className="lineDiv">
            <img src="https://raphacure-public-images.s3.ap-south-1.amazonaws.com/120521-1736415152396.png" alt="" />
          </div>
