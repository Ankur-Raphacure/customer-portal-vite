...
const Data = [
  {
    ...
    subContent:
      "Streamline corporate healthcare with Raphaplus. Manage employee healthcare plans and wellness programs efficiently. Boost productivity with our all-in-one system and get a free professional portal.",
  ...
  },
  {
    ...
    subContent:
      "Optimize your clinic operations with Raphaplus. Manage staff, patients, and appointments seamlessly while boosting revenue with our marketing tools. Enjoy a free professional website and management system.",
  ...
  },
  {
    ...
    flexreverse: "",
    subContent:
      "Manage your health with Raphaplus. Schedule appointments, access secure records, and communicate with providers. Enjoy a free personal health portal.",
    listImage: TicklightBlue,
    ListsOne: [
  ...
  return (
    <RaphacureAppStyled>
      {Data.map((item, index) => {
        return (
          <div
            className={`conatiner-sec ${item.backgroundClass} ${item.textColor} ${item.flexreverse}`}
          >
