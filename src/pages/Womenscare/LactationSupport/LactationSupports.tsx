...
import { LactationSupportsStyled } from "./LactationSupports.styled";

const LactationSupports = () => {
  const history = useHistory();
  return (
    <Container fluid className="p-5 main-div">
      <LactationSupportsStyled>
        <Row>
          <Col xs={12}>
            <button
        ...
        <Row className="align-items-center ">
          <Col className="text-center text-lg-start left-div">
            ...
            <div className="d-flex justify-content-center justify-content-lg-start butons-div">
              <Button variant="dark" className="me-3" size="lg">
                <img
                  src="https://raphacure-public-images.s3.ap-south-1.amazonaws.com/105748-1736395690959.png"
                  alt="Google Play"
              ...
              <Button variant="dark" size="lg">
                <img
                  src="https://raphacure-public-images.s3.ap-south-1.amazonaws.com/105748-1736395660042.png"
                  alt="App Store"
          ...
          <Col lg={5} md={12} className="text-center">
            <img
              src="https://raphacure-public-images.s3.ap-south-1.amazonaws.com/105748-1736395591750.png"
              alt="App Screenshot"
        ...
        <Row className="align-items-center mt-5">
          <Col lg={4} md={4} className="text-center mb-4 mb-md-0">
            <img
              src="https://raphacure-public-images.s3.ap-south-1.amazonaws.com/105748-1736395620211.png"
              alt="Period Tracker App"
              className="img-fluid"
            />
          </Col>
          <Col lg={8} md={6} className="position-relative">
            <h1 className="display-6 Period-title">Lactation Support</h1>
            <p className="lead">
              Rapha Cure's
              <span className="sub-discription">
                mobile app offers personalized lactation support, whether you
                choose breastfeeding for bonding and nutrition, bottle feeding
                for flexibility, or transitioning to baby food to meet growing
                nutritional needs.
              </span>
            </p>
...
export default LactationSupports;
