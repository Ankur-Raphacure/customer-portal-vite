            ...
            <div className="form-sec">
                ...
                <div className="upload-resume">
                    ...
                    <label htmlFor="resumeUpload" className="upload-button">
                        ...
                        <p className="text-secondary">This will auto-fill the fields below. 10MB max file size</p>
                    </label>
                </div>
                ...
                <div className='input-sec d-flex gap-4'>
                    <div className="input-div">
                        <p>Mobile Phone <span className="text-danger">*</span></p>
                        <input
                            type="text"
                            id="mobilePhone"
                            value={mobilePhone}
                    ...
                    <div className="input-div">
                        <p>Experience <span className="text-danger">*</span></p>
                        <input
                            type="number"
                            id="experienceYears"
                ...
                <div className="additional-documents-sec">
                    ...
                    <div className="additional-documents">
                        <input
                            ...
                            hidden
                        />
                        <label htmlFor="additionalDocuments" className="upload-button d-flex align-items-center gap-2">
                        ...
                        <div className="d-flex gap-4">
                            <div className="experience-sec d-flex">
                                <input
                                    ...
                                    onChange={(e) => setExperienceYears(e.target.value)}
                                />
                                <button type="button" id="button-addon1">Years</button>
                            </div>
                            <div className="experience-sec d-flex">
                                <select
                                    id="Month"
                                ...
                                <button type="button" id="button-addon1">Months</button>
                            </div>
                        </div>
                    </div>
                    <div className="input-div">
                ...
                <div className="captcha-sec d-flex mt-5">
                    ...
                    >
                        <img src={Loader} className={` ${isGenerateCaptcha ? "spinner-icon" : ""}`} />
                    </span>
                    <input
                        type="text"
                        id="user-input"
                ...
                <div className="confirmation-sec d-flex mt-2 gap-1 ">
                    <input
                        type="checkbox"
                    />
                    <p>By applying, you hereby accept the data processing terms under the <span>Privacy Policy</span>  and give consent to processing of the data as part of this job application.</p>
                </div>
                <div className="pb-5">
                    <button
