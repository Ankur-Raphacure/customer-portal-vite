...
const Bipolar = () => {
  ...
  const questions = [
    ...
    {
        question:"Over the last 2 weeks, how often have you experienced periods of feeling hopeless or down?",
        options: ["Not at all", "Several days", "More then half the days", "Nearly every day"]  
    },
    {
        question:"Over the last 2 weeks, how frequently have you noticed changes in appetite or weight during mood changes?",
        options: ["Not at all", "Several days", "More then half the days", "Nearly every day"]  
    },
  ];
