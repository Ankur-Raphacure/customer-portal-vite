...
const ADHD = () => {
  ...
  const questions = [
    ...
    {
      question:
        "How often do you struggle to locate or find important items at home or at work?",
      options: ["Never", "Rarely", "Sometimes", "Often", "Very Often"],
    },
    {
      question:
        "How often does noise or activity in your surroundings divert your attention from the task at hand?",
      options: ["Never", "Rarely", "Sometimes", "Often", "Very Often"],
    },
    {
      question:
    ...
    {
      question:
        "How often do you experience a need to move or fidget, even when you are supposed to be still?",
      options: ["Never", "Rarely", "Sometimes", "Often", "Very Often"],
    },
    {
      question:
        "How often do you find it challenging to relax and unwind when you have free time?",
      options: ["Never", "Rarely", "Sometimes", "Often", "Very Often"],
    },
    {
      question:
        "How often do you catch yourself speaking more than others or dominating conversations in social settings?",
      options: ["Never", "Rarely", "Sometimes", "Often", "Very Often"],
    },
    {
      question:
        "How often do you interrupt people when they are engaged in a task or conversation?",
      options: ["Never", "Rarely", "Sometimes", "Often", "Very Often"],
    },
  ];
