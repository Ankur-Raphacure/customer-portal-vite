...
const ChatContextProvider = ({ children }: any) => {
  ...
  // const [doctorsList, setDoctorsList] = useState<doctorsListDto>({})
  ...
  //     const res: any = await dispatch(patientDoctorsAPI(userChatId));
  //     if (res?.payload?.doctors) {
  //       const basicDoctorsList : doctorsListDto = {}
  //       res.payload.doctors.forEach((doc: any) => {
  //         basicDoctorsList[doc?.id?.toString()] = {
  //           name: doc?.name,
  //           photo: doc?.photo,
  //         }
  //       });

  //       setDoctorsList(basicDoctorsList)
  //     }
  //   } catch (error) {
