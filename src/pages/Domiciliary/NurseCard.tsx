    ...
    <div className="nurse-card-list">
      <div className="nurse-card">
        ...
        <p className="experience">
          {" "}
          <Image src="https://raphacure-public-images.s3.ap-south-1.amazonaws.com/120521-1736500403635.png" />{" "}
          {item?.years_of_experience ?? "1"} Years Experience
        </p>
        <p className="languages">
          {" "}
          <Image src="https://raphacure-public-images.s3.ap-south-1.amazonaws.com/120521-1736500447140.png" />{" "}
