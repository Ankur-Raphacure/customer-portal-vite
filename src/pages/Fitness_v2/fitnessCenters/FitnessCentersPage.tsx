...
import { handleAddToCartAPI,getCartItemsAPI } from "../../../redux/slices/checkout/checkoutService";
...
import { getCategoriesAPI, getGymVendorsAPI } from "../../../redux/slices/generic/genericService";
...
const FitnessCenterPage = (props: any) => {
  ...
  const { allGymVendorsList, allGymCategoriesList } = useSelector(
    ...
    console.log("hai")
    console.log("all gym",allGymVendorsList)
    console.log("all gym categories",allGymCategoriesList)
        ...
        <div className="all-pharmacy-page-div">
          ...
          <div className="right-card-module-div">
            ...
            <div className="card-module-div">
              {Object.keys(allGymCategoriesList).length > 0 && allGymCategoriesList?.vendors?.map((item: any) => {
