            ...
            <div className="gym-left-content-view-div">
              <img
                src={
                  item?.image
                    ? item?.image
                    : "https://raphacure-public-images.s3.ap-south-1.amazonaws.com/119535-1736403457823.png"
                }
                alt=""
                className="w-100"
              />
            ...
            <div className="gym-right-content-view-div d-flex">
              <div className="d-flex">
                <div className="column-images d-flex flex-column me-4">
                  <img
                    src={
                      "https://raphacure-public-images.s3.ap-south-1.amazonaws.com/119535-1736403220159.png"
                    }
                    alt="Gym View 1"
                    className="mb-3"
                  />{" "}
                  <img
                    src={
                      "https://raphacure-public-images.s3.ap-south-1.amazonaws.com/119535-1736403595320.png"
                    }
                    alt="Gym View 2"
                    className="mb-3"
                  />
                ...
                <div className="final-column-images">
                  <img
                    src={
                      "https://raphacure-public-images.s3.ap-south-1.amazonaws.com/119535-1736403538735.png"
                    }
                    alt="Gym View 3"
                  />
