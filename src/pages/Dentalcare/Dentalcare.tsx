...
import Eycareimg from "../../assets/images/dentalcare/dentalbg.png";
import { useHistory } from "react-router-dom";
import DentalCatogory from "./Dentalcategory";
      ...
      <div className="eycare-design">
        <div className="eyecarebanner">
          <div className="container-fluid">
            <div className="row">
              <div className="col-md-7 dental-care-title-div">
                <h2>
                  A Better Life Starts with A <br /> Beautiful Smile
                </h2>
                <p>
                  Dental hospitals are healthcare facilities that specialize in{" "}
                  <br />
                  providing dental care service to patients
                </p>
                <button className="consult-btn" onClick={handleShow}>
        ...
        <div className="eycare-nearclinic">
          <div className="container">
            <div className="row heading">
              <h4>
                Near by Clinics({alldentalcareNearClinic?.vendors?.length})
              </h4>
            </div>
            <div className="row">
              <Clinicsnear />
