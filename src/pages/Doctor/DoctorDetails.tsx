...
const DoctorDetails = () => {
  ...
  const { doctorDetailList } = useSelector(
    (ReduxState: any) => ReduxState.doctor
  );
  const doctorDetails = doctorDetailList?.data;
  ...
  const getAllDoctorsList = async () => {
    await dispatch(getDoctorDetailAPI(id));
  };
        ...
        <div className="main-container">
                  ...
                  <div className="profile">
                    ...
                    <div className="exp">
                      ...
                      <span className="experience">
                        {doctorDetails?.work_experience_years}+ Years Experience
                      </span>
                    </div>
                  </div>
                  <div className="info">
                    <h2 className="name">{doctorDetails?.name}</h2>
                    <p className="title">{doctorDetails?.specialization}</p>
                    <div className="qua">
                      <img
                    ...
                    <div className="lang">
                      <img
                        ...
                        alt=""
                      />
                      <p className="languages">{doctorDetails?.languages}</p>
                    </div>
          ...
          <div className="right-side">
            <div className="time-slot-picker">
              ...
              <div className="fee">
                <h1>
                  {isVirtual ? "Virtual Appointment" : "Clinic Appointment"}{" "}
                </h1>
              ...
              <div className="time-slot-container">
                {["Morning", "Afternoon", "Evening"].map((section, index) => {
                  const sectionSlots = days[selectedDay].slots.filter(
                    (slot) => {
