import { HospitalheaderStyled } from "./hospitalheader.styled";
import hospitalimg from "../../../assets/images/doctor/hospital_placeholder.png";
...
const HospitalHeader = (props: any) => {
