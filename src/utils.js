import { ZEGOCLOUD_CHAT_APPID, ZEGOCLOUD_CHAT_SERVER_SECRET } from "./config";
import CryptoJS from "crypto-js";

const appConfig = {
  appID: parseInt(ZEGOCLOUD_CHAT_APPID), // Fill in the AppID you applied for
  serverSecret: ZEGOCLOUD_CHAT_SERVER_SECRET, // Fill in the ServerSecret you applied for
};
