import{r as t,u as S,j as e,d as j,au as k,av as N,M as z,aw as C,ax as E,b as D,a as M,s as A,S as B,x as H,P,I as q,ay as L,t as U,o as _,p as G}from"./index-DDOdRoFT.js";const O=({siteDetails:o})=>{const[a,h]=t.useState({}),[n,l]=t.useState(""),s=S();t.useEffect(()=>{h(o)},[o]);const m=(a==null?void 0:a.banner_images)||[];t.useEffect(()=>{m.length>0&&l(m[0])},[m]);const u=(f,r)=>{l(f),r===3&&(console.log("All gallery images:",m),s.push({pathname:"/gallery",state:{gallery:m}}))};return e.jsxs("div",{className:"galleryPreview",children:[e.jsx("div",{className:"otherImages",children:m.slice(0,4).map((f,r)=>e.jsxs("div",{className:`image ${n===f?"active":""}`,onClick:()=>u(f,r),children:[e.jsx("img",{src:f,alt:`Gallery Image ${r+1}`}),r===3&&e.jsx("div",{className:"imageOverlay",children:e.jsxs("span",{children:[m.length,"+"]})})]},r))}),e.jsx("div",{className:"currImage",children:n?e.jsxs(e.Fragment,{children:[e.jsx("img",{src:n,alt:"Current Preview"}),e.jsx("div",{className:"head",children:e.jsxs("h1",{children:["Your Partner in ",e.jsx("br",{})," Health & Wellness"]})})]}):e.jsx("p",{children:"No image selected"})})]})},V=j.div`
.specialization {
    padding: 0px 40px;
    .paragraph {
      display: flex;
