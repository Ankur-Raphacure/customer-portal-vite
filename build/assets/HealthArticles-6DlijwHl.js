import{r as i,aX as X,j as e,ah as _,cH as Me,fe as Ae,cK as Te,ff as Be,aY as le,fg as $e,cJ as oe,fh as ce,fi as Ve,fj as Fe,d as C}from"./index-BHf3qlKB.js";import{H as m,a as me,M as Oe}from"./notification-CRD5Z78M.js";import{u as ze}from"./useTimeout-Dn84WHli.js";function Pe(a,n){const l=i.useRef(!0);i.useEffect(()=>{if(l.current){l.current=!1;return}return a()},n)}const pe=i.forwardRef(({className:a,bsPrefix:n,as:l="div",...c},o)=>(n=X(n,"carousel-caption"),e.jsx(l,{ref:o,className:_(a,n),...c})));pe.displayName="CarouselCaption";const xe=i.forwardRef(({as:a="div",bsPrefix:n,className:l,...c},o)=>{const g=_(l,X(n,"carousel-item"));return e.jsx(a,{ref:o,...c,className:g})});xe.displayName="CarouselItem";const Xe=40;function We(a){if(!a||!a.style||!a.parentNode||!a.parentNode.style)return!1;const n=getComputedStyle(a);return n.display!=="none"&&n.visibility!=="hidden"&&getComputedStyle(a.parentNode).display!=="none"}const he=i.forwardRef(({defaultActiveIndex:a=0,...n},l)=>{const{as:c="div",bsPrefix:o,slide:g=!0,fade:fe=!1,controls:ge=!0,indicators:L=!0,indicatorLabels:M=[],activeIndex:h,onSelect:f,onSlide:q,onSlid:k,interval:S=5e3,keyboard:W=!0,onKeyDown:A,pause:j="hover",onMouseOver:T,onMouseOut:B,wrap:H=!0,touch:K=!0,onTouchStart:$,onTouchMove:V,onTouchEnd:F,prevIcon:ve=e.jsx("span",{"aria-hidden":"true",className:"carousel-control-prev-icon"}),prevLabel:U="Previous",nextIcon:be=e.jsx("span",{"aria-hidden":"true",className:"carousel-control-next-icon"}),nextLabel:Z="Next",variant:G,className:je,children:O,...we}=Me({defaultActiveIndex:a,...n},{activeIndex:"onSelect"}),p=X(o,"carousel"),w=Ae(),N=i.useRef(null),[J,Y]=i.useState("next"),[Ne,E]=i.useState(!1),[y,Q]=i.useState(!1),[r,ye]=i.useState(h||0);i.useEffect(()=>{!y&&h!==r&&(N.current?Y(N.current):Y((h||0)>r?"next":"prev"),g&&Q(!0),ye(h||0))},[h,y,r,g]),i.useEffect(()=>{N.current&&(N.current=null)});let v=0,ee;Te(O,(t,s)=>{++v,s===h&&(ee=t.props.interval)});const te=Be(ee),d=i.useCallback(t=>{if(y)return;let s=r-1;if(s<0){if(!H)return;s=v-1}N.current="prev",f==null||f(s,t)},[y,r,f,H,v]),u=le(t=>{if(y)return;let s=r+1;if(s>=v){if(!H)return;s=0}N.current="next",f==null||f(s,t)}),z=i.useRef();i.useImperativeHandle(l,()=>({element:z.current,prev:d,next:u}));const ie=le(()=>{!document.hidden&&We(z.current)&&(w?d():u())}),b=J==="next"?"start":"end";Pe(()=>{g||(q==null||q(r,b),k==null||k(r,b))},[r]);const Ce=`${p}-item-${J}`,qe=`${p}-item-${b}`,ke=i.useCallback(t=>{$e(t),q==null||q(r,b)},[q,r,b]),Se=i.useCallback(()=>{Q(!1),k==null||k(r,b)},[k,r,b]),He=i.useCallback(t=>{if(W&&!/input|textarea/i.test(t.target.tagName))switch(t.key){case"ArrowLeft":t.preventDefault(),w?u(t):d(t);return;case"ArrowRight":t.preventDefault(),w?d(t):u(t);return}A==null||A(t)},[W,A,d,u,w]),De=i.useCallback(t=>{j==="hover"&&E(!0),T==null||T(t)},[j,T]),Re=i.useCallback(t=>{E(!1),B==null||B(t)},[B]),se=i.useRef(0),I=i.useRef(0),ae=ze(),_e=i.useCallback(t=>{se.current=t.touches[0].clientX,I.current=0,j==="hover"&&E(!0),$==null||$(t)},[j,$]),Ee=i.useCallback(t=>{t.touches&&t.touches.length>1?I.current=0:I.current=t.touches[0].clientX-se.current,V==null||V(t)},[V]),Ie=i.useCallback(t=>{if(K){const s=I.current;Math.abs(s)>Xe&&(s>0?d(t):u(t))}j==="hover"&&ae.set(()=>{E(!1)},S||void 0),F==null||F(t)},[K,j,d,u,ae,S,F]),ne=S!=null&&!Ne&&!y,P=i.useRef();i.useEffect(()=>{var t,s;if(!ne)return;const x=w?d:u;return P.current=window.setInterval(document.visibilityState?ie:x,(t=(s=te.current)!=null?s:S)!=null?t:void 0),()=>{P.current!==null&&clearInterval(P.current)}},[ne,d,u,te,S,ie,w]);const re=i.useMemo(()=>L&&Array.from({length:v},(t,s)=>x=>{f==null||f(s,x)}),[L,v,f]);return e.jsxs(c,{ref:z,...we,onKeyDown:He,onMouseOver:De,onMouseOut:Re,onTouchStart:_e,onTouchMove:Ee,onTouchEnd:Ie,className:_(je,p,g&&"slide",fe&&`${p}-fade`,G&&`${p}-${G}`),children:[L&&e.jsx("div",{className:`${p}-indicators`,children:oe(O,(t,s)=>e.jsx("button",{type:"button","data-bs-target":"","aria-label":M!=null&&M.length?M[s]:`Slide ${s+1}`,className:s===r?"active":void 0,onClick:re?re[s]:void 0,"aria-current":s===r},s))}),e.jsx("div",{className:`${p}-inner`,children:oe(O,(t,s)=>{const x=s===r;return g?e.jsx(Ve,{in:x,onEnter:x?ke:void 0,onEntered:x?Se:void 0,addEndListener:Fe,children:(D,Le)=>i.cloneElement(t,{...Le,className:_(t.props.className,x&&D!=="entered"&&Ce,(D==="entered"||D==="exiting")&&"active",(D==="entering"||D==="exiting")&&qe)})}):i.cloneElement(t,{className:_(t.props.className,x&&"active")})})}),ge&&e.jsxs(e.Fragment,{children:[(H||h!==0)&&e.jsxs(ce,{className:`${p}-control-prev`,onClick:d,children:[ve,U&&e.jsx("span",{className:"visually-hidden",children:U})]}),(H||h!==v-1)&&e.jsxs(ce,{className:`${p}-control-next`,onClick:u,children:[be,Z&&e.jsx("span",{className:"visually-hidden",children:Z})]})]})]})});he.displayName="Carousel";const de=Object.assign(he,{Caption:pe,Item:xe}),Ke=C.div`
  .main-card {
  }
  .health-article {
...
`,Ye=()=>{const[a,n]=i.useState(3),l=[{id:1,title:"Complete Health care check up 1",description:"cin voluptate velit essveniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute"},{id:2,title:"Complete Health care check up 2",description:"cin voluptate velit essveniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit ess aute irure dolor in reprehenderit in voluptate velit essveniam, quis nostrud veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit essveniam, quis "}];return e.jsx(Je,{children:e.jsx("div",{className:"main-card",children:l.slice(0,a).map(c=>e.jsxs("div",{children:[e.jsx("div",{className:"near-you-item",children:e.jsxs("div",{className:" cardstyle px-4 py-2 flex  flex-col",children:[e.jsx("div",{className:"relative imgspace",children:e.jsx("img",{src:m,alt:"Health360",className:"w-full h-full object-cover rounded-t-xl w-xl"})}),e.jsx("div",{className:"mt-4",children:e.jsxs("div",{className:"bottom-name",children:[e.jsxs("div",{className:"d-flex ",children:[e.jsxs("div",{className:"d-flex ",children:[" ",e.jsx("img",{src:me,alt:""})]}),e.jsx("div",{className:"name-tag",children:e.jsx("p",{className:"text-sm",children:"Syam varghese"})})]}),e.jsxs("div",{className:"d-flex",children:[e.jsx("p",{className:"",children:"20 Aug 2024"}),e.jsxs("p",{className:"name-tag",children:[e.jsx("img",{src:Oe,alt:""})," 10 comments"]})]})]})})]})}),e.jsx("h3",{children:"Navigating the Path to Wellness"}),e.jsx("p",{className:"text-justify",children:"cin voluptate velit essveniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit ess aute irure dolor in reprehenderit in voluptate velit essveniam, quis nostrud veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit essveniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit ess aute irure dolor in reprehenderit in voluptate velit essveniam, quis nostrud veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit essveniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit ess aute irure dolor in reprehenderit in voluptate velit essveniam, quis nostrud veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit essveniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit ess aute irure dolor in reprehenderit in voluptate velit essveniam, quis nostrud"})]}))})})},Qe=C.div`
